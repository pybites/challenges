...
# Need to get your APPID from https://openweathermap.org
APPID = 'YOU-OPEN-WEATHER-APPID'
...
while input_val != 'E':
    payload = {'q': input_val, 'appid': APPID}
    ...
    payload = {'appid': APPID, 'lat': latitude, 'lon': longitude, 'cnt': 5, 'start':
