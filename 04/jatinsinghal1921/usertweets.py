...
class UserTweets(object):
    ...
    def __init__(self, handle, max_id=None):
        ...
        self.output_file = self._save_tweets()
    ...
    def _get_tweets(self):
        ...
        tweets = (self.api).user_timeline(screen_name = self.handle, count = NUM_TWEETS, since_id = self.max_id)
        return tweets
