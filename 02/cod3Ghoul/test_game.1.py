...
from game import WordPossibilities # replaced "from game import get_possible_dict_words, _get_permutations_draw"
...
class TestGame(unittest.TestCase):
    ...
    def test_get_permutations_draw(self):
        ...
        game_permutations = len(list(WordPossibilities.get_possible_dict_words(self.draw))
